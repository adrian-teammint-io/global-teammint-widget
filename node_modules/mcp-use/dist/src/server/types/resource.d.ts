...
interface BaseUIResourceDefinition {
     ...
     * ```
     */
    toolOutput?: ((params: Record<string, any>) => import("@mcp-use/modelcontextprotocol-sdk/types.js").CallToolResult | import("../utils/response-helpers.js").TypedCallToolResult<any>) | import("@mcp-use/modelcontextprotocol-sdk/types.js").CallToolResult | import("../utils/response-helpers.js").TypedCallToolResult<any>;
    _meta?: Record<string, unknown>;
}
/**
