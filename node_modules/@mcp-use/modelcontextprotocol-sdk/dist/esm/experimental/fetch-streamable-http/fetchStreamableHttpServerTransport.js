 ...
 * @experimental
 */
export class FetchStreamableHTTPServerTransport {
    constructor(options) {
        var _a, _b;
        this._started = false;
        ...
        try {
            ...
            if (isInitializationRequest) {
                ...
                if (this.sessionId && this._sessionStore) {
                    const protocolVersion = (_b = req.headers.get('mcp-protocol-version')) !== null && _b !== void 0 ? _b : DEFAULT_NEGOTIATED_PROTOCOL_VERSION;
    ...
    validateProtocolVersion(req) {
        var _a;
        const protocolVersion = (_a = req.headers.get('mcp-protocol-version')) !== null && _a !== void 0 ? _a : DEFAULT_NEGOTIATED_PROTOCOL_VERSION;
        if (!SUPPORTED_PROTOCOL_VERSIONS.includes(protocolVersion)) {
            return this.createJsonErrorResponse(400, -32000, `Bad Request: Unsupported protocol version (supported versions: ${SUPPORTED_PROTOCOL_VERSIONS.join(', ')})`);
        }
        return undefined;
    }
    async close() {
