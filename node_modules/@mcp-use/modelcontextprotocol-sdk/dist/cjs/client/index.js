...
class Client extends protocol_js_1.Protocol {
    ...
    constructor(_clientInfo, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.listChanged) {
    ...
    _setupListChangedHandlers(config) {
        ...
        if (config.tools && ((_b = (_a = this._serverCapabilities) === null || _a === void 0 ? void 0 : _a.tools) === null || _b === void 0 ? void 0 : _b.listChanged)) {
            this._setupListChangedHandler('tools', types_js_1.ToolListChangedNotificationSchema, config.tools, async () => {
                const result = await this.listTools();
                return result.tools;
            });
        }
        if (config.prompts && ((_d = (_c = this._serverCapabilities) === null || _c === void 0 ? void 0 : _c.prompts) === null || _d === void 0 ? void 0 : _d.listChanged)) {
            this._setupListChangedHandler('prompts', types_js_1.PromptListChangedNotificationSchema, config.prompts, async () => {
                const result = await this.listPrompts();
                return result.prompts;
            });
        }
        if (config.resources && ((_f = (_e = this._serverCapabilities) === null || _e === void 0 ? void 0 : _e.resources) === null || _f === void 0 ? void 0 : _f.listChanged)) {
