...
exports.FetchStreamableHTTPServerTransport = void 0;
 ...
 * @experimental
 */
class FetchStreamableHTTPServerTransport {
    constructor(options) {
        var _a, _b;
        this._started = false;
     ...
     */
    createJsonErrorResponse(status, code, message, headers) {
    ...
    validateRequestHeaders(req) {
        ...
        if (this._allowedHosts && this._allowedHosts.length > 0) {
            ...
            if (!hostHeader || !this._allowedHosts.includes(hostHeader)) {
                ...
                (_a = this.onerror) === null || _a === void 0 ? void 0 : _a.call(this, new Error(error));
        ...
        if (this._allowedOrigins && this._allowedOrigins.length > 0) {
            ...
            if (!originHeader || !this._allowedOrigins.includes(originHeader)) {
                ...
                (_b = this.onerror) === null || _b === void 0 ? void 0 : _b.call(this, new Error(error));
                return this.createJsonErrorResponse(403, -32000, error);
            }
        }
        return undefined;
     ...
     */
    async writePrimingEvent(controller, encoder, streamId) {
        if (!this._eventStore) {
            return;
        }
    ...
    async handlePostRequest(req) {
        ...
        try {
            ...
            if (isInitializationRequest) {
                ...
                this.sessionId = (_a = this.sessionIdGenerator) === null || _a === void 0 ? void 0 : _a.call(this);
                this._initialized = true;
                // Persist session state to external store if configured
                if (this.sessionId && this._sessionStore) {
                    const protocolVersion = (_b = req.headers.get('mcp-protocol-version')) !== null && _b !== void 0 ? _b : types_js_1.DEFAULT_NEGOTIATED_PROTOCOL_VERSION;
            ...
            if (!hasRequests) {
                ...
                for (const message of messages) {
                    (_c = this.onmessage) === null || _c === void 0 ? void 0 : _c.call(this, message, { requestInfo });
                }
            ...
            if (this._enableJsonResponse) {
                ...
                return new Promise(resolve => {
                    ...
                    for (const message of messages) {
                        (_a = this.onmessage) === null || _a === void 0 ? void 0 : _a.call(this, message, { requestInfo });
                    }
                });
            }
            ...
            for (const message of messages) {
                ...
                (_d = this.onmessage) === null || _d === void 0 ? void 0 : _d.call(this, message, { requestInfo, closeSSEStream, closeStandaloneSSEStream });
            }
    ...
    validateProtocolVersion(req) {
        var _a;
        const protocolVersion = (_a = req.headers.get('mcp-protocol-version')) !== null && _a !== void 0 ? _a : types_js_1.DEFAULT_NEGOTIATED_PROTOCOL_VERSION;
        if (!types_js_1.SUPPORTED_PROTOCOL_VERSIONS.includes(protocolVersion)) {
            return this.createJsonErrorResponse(400, -32000, `Bad Request: Unsupported protocol version (supported versions: ${types_js_1.SUPPORTED_PROTOCOL_VERSIONS.join(', ')})`);
        }
        return undefined;
    }
    async close() {
    ...
    async send(message, options) {
        ...
        const stream = this._streamMapping.get(streamId);
        if (!this._enableJsonResponse && (stream === null || stream === void 0 ? void 0 : stream.controller) && (stream === null || stream === void 0 ? void 0 : stream.encoder)) {
...
exports.FetchStreamableHTTPServerTransport = FetchStreamableHTTPServerTransport;
//# sourceMappingURL=fetchStreamableHttpServerTransport.js.map