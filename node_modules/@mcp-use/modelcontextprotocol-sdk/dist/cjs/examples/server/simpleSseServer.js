...
const getServer = () => {
    ...
    server.tool('start-notification-stream', 'Starts sending periodic notifications', {
        interval: v4_1.default.number().describe('Interval in milliseconds between notifications').default(1000),
        count: v4_1.default.number().describe('Number of notifications to send').default(10)
