...
const getServer = () => {
    ...
    server.registerTool('greet', {
        ...
        inputSchema: {
            name: v4_1.default.string().describe('Name to greet')
        }
    }, async ({ name }) => {
        return {
            content: [
    ...
    server.tool('collect-user-info', 'A tool that collects user information through form elicitation', {
        infoType: v4_1.default.enum(['contact', 'preferences', 'feedback']).describe('Type of information to collect')
    ...
    server.registerPrompt('greeting-template', {
        ...
        argsSchema: {
            name: v4_1.default.string().describe('Name to include in greeting')
        }
    }, async ({ name }) => {
        return {
            messages: [
    ...
    server.tool('start-notification-stream', 'Starts sending periodic notifications for testing resumability', {
        interval: v4_1.default.number().describe('Interval in milliseconds between notifications').default(100),
        count: v4_1.default.number().describe('Number of notifications to send (0 for 100)').default(50)
    ...
    server.registerTool('list-files', {
        ...
        inputSchema: {
            includeDescriptions: v4_1.default.boolean().optional().describe('Whether to include descriptions in the resource links')
        }
    ...
    server.experimental.tasks.registerToolTask('delay', {
        ...
        inputSchema: {
            duration: v4_1.default.number().describe('Duration in milliseconds').default(5000)
        }
    }, {
