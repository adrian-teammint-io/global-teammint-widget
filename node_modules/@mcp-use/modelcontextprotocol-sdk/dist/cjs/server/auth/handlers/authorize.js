...
const ClientAuthorizationParamsSchema = v4_1.default.object({
    client_id: v4_1.default.string(),
    redirect_uri: v4_1.default
        .string()
        .optional()
        .refine(value => value === undefined || URL.canParse(value), { message: 'redirect_uri must be a valid URL' })
});
// Parameters that must be validated for a successful authorization request. Failure can be reported to the redirect URI.
const RequestAuthorizationParamsSchema = v4_1.default.object({
    response_type: v4_1.default.literal('code'),
    code_challenge: v4_1.default.string(),
    code_challenge_method: v4_1.default.literal('S256'),
    scope: v4_1.default.string().optional(),
    state: v4_1.default.string().optional(),
    resource: v4_1.default.string().url().optional()
});
