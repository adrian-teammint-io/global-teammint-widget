...
const TokenRequestSchema = v4_1.default.object({
    grant_type: v4_1.default.string()
});
const AuthorizationCodeGrantSchema = v4_1.default.object({
    code: v4_1.default.string(),
    code_verifier: v4_1.default.string(),
    redirect_uri: v4_1.default.string().optional(),
    resource: v4_1.default.string().url().optional()
});
const RefreshTokenGrantSchema = v4_1.default.object({
    refresh_token: v4_1.default.string(),
